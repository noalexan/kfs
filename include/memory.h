...
#define PAGE_IS_ALLOCATED(page)     (FLAG_IS_SET((page)->flags, PAGE_ALLOCATED) || FLAG_IS_SET((page)->flags, PAGE_RESERVED))
#define PAGE_IS_FREE(page)          (!PAGE_IS_ALLOCATED(page))
