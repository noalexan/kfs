...
enum Gdt_Access_Byte {
	ACCESS_BIT =
	    0b00000001, // Bit 0: Indique si le segment a été accédé par le CPU
	RW_BIT =
	    0b00000010, // Bit 1: Lecture/écriture pour données, lecture pour code
	DC_BIT = 0b00000100, // Bit 2: Direction pour données, Conforming pour code
	EXECUTABLE_BIT =
	    0b00001000, // Bit 3: 1=segment de code, 0=segment de données
	DESCRIPTOR_TYPE =
	    0b00010000, // Bit 4: 1=segment code/données, 0=segment système
	...
	PRESENT_BIT =
	    0b10000000 // Bit 7: Indique si le segment est présent en mémoire
};

enum Gdt_Flags {
	RESERVED_BIT = 0b0001, // Bit 0: Réservé, doit être à 0
	LONG_MODE_BIT =
	    0b0010, // Bit 1: 1=segment 64-bit (mode long), 0=mode protégé standard
	SEGMENT_SIZE_BIT = 0b0100, // Bit 2: 0=16-bit segment, 1=32-bit segment
	GRANULARITY_BIT =
	    0b1000 // Bit 3: 0=limite en octets, 1=limite en pages de 4Ko
};
